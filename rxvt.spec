...
substituto de xterm(1) para usuarios que no necesiten de las caracterМsticas
mАs esotИricas de xterm. EspecМficamente rxvt no implementa la emulaciСn
Tektronix 4014, registro de sesiСn y configurabilidad en el estilo toolkit.
Como resultado, rxvt usa mucho menos swap del que xterm - una ventaja
significativa en una mАquina sirviendo varias sesiones X.
...
%description -l pt_BR
Rxvt И um emulador de terminal VT100 para X. Ele tem o objetivo de ser um
substituto de xterm(1) para usuАrios que nЦo necessitam das caracterМsticas
mais esotИricas de xterm. Especificamente rxvt nЦo implementa a emulaГЦo
Tektronix 4014, registro de sessЦo e configurabilidade no estilo toolkit. Como
resultado, rxvt usa muito menos swap do que xterm - uma vantagem significativa
em uma mАquina servindo vАrias sessУes X.
